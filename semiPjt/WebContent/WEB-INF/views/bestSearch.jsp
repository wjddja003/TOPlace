...
<section>
	...
	<div class="totalOutLine">
		<div class="searchInfo">
			<span id="selectVal" style="color:#f69b02;font-weight:bold;font-size:30px; border-bottom:4px solid #f69b02">조회수 TOP6</span><span style="font-weight:100;font-size:20px;">  공간 보기</span>
		</div>
				...
				<div class='totalInnerBox'>
					...
					<div style='height:140px; padding-left:5px;border:1px solid #f69b02;'>
						...
						<c:if test="${hits.s_type eq 'day' }">
							&nbsp;<span style="font-size:22px; color:#f69b02;">￦ <fmt:formatNumber type="number" maxFractionDigits="3" value="${hits.s_price1}" /></span><span> 원/일</span>
						</c:if>
					</div>
				</div>
			</c:forEach>
		...
		<div class="totalOutLine">
		<div class="searchInfo">
			<span id="selectVal" style="color:#f69b02;font-weight:bold;font-size:30px; border-bottom:4px solid #f69b02">좋아요 TOP6</span><span style="font-weight:100;font-size:20px;">  공간 보기</span>
		</div>
