...
<div id="content_wraper" role="main">
        <section class="section_content" style="padding:45px 50px 100px;">
            <div class="heading_agree">
                ...
                <p class="p_enforce_date">시행일자 : 2019년 6월 13일</p>
            </div>
            <div class="agree_wrap">
                <dl>
                    <dt>제 1 조 (목적)</dt>
                    <dd>이 약관은 주식회사 투플레이스("회사" )가 제공하는 투플레이스 온라인 서비스(<a href="http://localhost">http://localhost</a>)(이하 “서비스”라고 합니다.)의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</dd>
                    <dt>제 2 조 (정의)</dt>
                    <dd>
                        <ol>
                            <li>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
                                <ol>
                                    <li>1.	 "서비스"라 함은 유휴 공간(이하 “공간”) 정보의 공유 및 예약을 위하여 “회사”가 투플레이스를 통해 제공하는 온라인 서비스를 말합니다.</li>
                                    <li>2.	“사이트”라 함은 “회사” 가 “서비스”를 운영하는 웹사이트를 의미하며, 현재는 (<a href="http://localhost">http://localhost</a>) 입니다.</li>
                                    <li>3.	회사의 "서비스"에 접속하여 이 약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 "서비스"를 이용하는 고객은 서비스 이용목적에 따라 “게스트회원”과 “호스트회원”으로 구분됩니다.
                                        <ol>
                                            ...
                                            <li>B.	호스트회원: “투플레이스 호스트 이용약관”에 따라 “회사”와 이용계약을 체결하고 “회사”가 제공하는 “서비스”를 통해 “공간” 및 컨텐츠를 등록하거나 제안할 수 있는 회원을 말합니다.</li>
                                        </ol>
                                    </li>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>2.	“회사”가 개인정보의 보호를 위하여 상당한 주의를 기울였음에도 불구하고, “호스트회원”이 관련 법령 및 “투플레이스 호스트 이용약관”을 위반하여 “회원”의 개인정보를 유출 또는 유용한 경우 “회사”는 그에 대하여 아무런 책임을 부담하지 않습니다.</li>
                        </ol>
                    </dd>
                    ...
                    <dt>부칙</dt>
                    <dd>이 약관은 2019년 06월 13일부터 적용됩니다.</dd>
                </dl>
            </div>
        </section>
    </div>
