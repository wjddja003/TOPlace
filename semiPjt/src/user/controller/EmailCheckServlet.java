	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			message.setContent("<!DOCTYPE html>\r\n" + 
					...
					"                                <p style=\"padding:15px; font-size: 30px; font-weight: 900;\"><span style=\"color:blue;\">TOPlace</span> 이메일 인증</p>\r\n" + 
					"                                <div class=\"mailContent\" style=\"background: white; border : 1px solid gray; width:85%\">\r\n" + 
					"                                    <p style=\"padding:30px 0 0 0; font-weight: 700;\">안녕하세요 <span style=\"color:blue;\">고객님</span><br>TOPlace 회원가입을 위한 이메일 인증 메일입니다.</p>\r\n" + 
