 ...
 */
@WebServlet(name = "HelpUpdate", urlPatterns = { "/helpUpdate" })
public class HelpUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Help h = new HelpService().selectOne(helpNo);
		request.setAttribute("help", h);
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/help/helpUpdate.jsp");
